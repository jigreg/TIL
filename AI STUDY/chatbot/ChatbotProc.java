...
public class ChatbotProc {
	...
	public static void main(String[] args) {
		//main("질문","apiurl","secretkey");
		
		//멀티링크답변
		//String chatbot = main("오늘 날씨 어때요?", 
		//"https://c89f948456fa4269a4f1d641a4dfb90f.apigw.ntruss.com/custom/v1/5515/1c7f45ba1553474dc67c6c5348c2a6ff0e1b59a4e54e64eed364aaaaf5b37770",
		//"bGNJSlF3a2RrcHBMSG5MSHR4d1JPT096VVVpcklYdUw=");
		...
		"https://c89f948456fa4269a4f1d641a4dfb90f.apigw.ntruss.com/custom/v1/5515/1c7f45ba1553474dc67c6c5348c2a6ff0e1b59a4e54e64eed364aaaaf5b37770",
		"bGNJSlF3a2RrcHBMSG5MSHR4d1JPT096VVVpcklYdUw=");
		System.out.println("웰컴메시지 = " + chatbot);// event:open 수정
...
//=> userId is a unique code for each chat user, not a fixed value, recommend use UUID. use different id for each user could help you to split chat history for users.
            ...
            obj.put("event", "send");//질문-답변( 기본, 이미지, 멀티링크 답변)
