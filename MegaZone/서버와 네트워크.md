...
키 쌍은 특정 인증 프로토콜에 사용되는 공개 키(자물쇠-서버) 및 프라이빗 키(열쇠-특정 폴더) 파일을 나타냅니다.
...
## 4. SAMBA(Server Message Block; 윈도우용 파일 공유 시스템)
...
## 5. NFS(Network File System; 리눅스용 파일 공유 시스템)
...
# mkdir share
# mount -t nfs 192.168.0.69:/share /root/share
# df -h
# vi /etc/fstab
